...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-07-29T03:55:41.127Z  
...
(
    ...
    Employee_Name   varchar(50), /* TEXT Data type assigned to the variable */
    Department  varchar(100) /* TEXT Data type assigned to the variable */
);
```
